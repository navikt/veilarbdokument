...
public class Values {
    public static final String TEST_VEILEDER_IDENT = "VEILEDER123";
    public static final String TEST_VEILEDER_TOKEN = "veileder_token";
    public static final String TEST_SRV_USERNAME = "username";
    public static final String TEST_SRV_PASSWORD = "password";
    public static final String TEST_AKTOR_ID = "678";
    public static final String TEST_JOURNALPOST_ID = "234";
    public static final String TEST_DOKUMENT_ID = "345";
    public static final String TEST_ENHET = "456";
